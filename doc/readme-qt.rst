SeedCoin-qt: Qt5 GUI for SeedCoin
===============================
...
Alternatively, install Qt Creator and open the `SeedCoin-qt.pro` file.
...
The static binary version of SeedCoin is linked against libdb 5.0 (see also `this Debian issue`_).
