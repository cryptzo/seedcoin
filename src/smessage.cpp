// Copyright (c) 2014 The seedCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("seedcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("seedcoin-smsg-pow"); // Make this thread recognisable
